    ...
    return (
        <div>
            ...
            <main className="flex flex-col items-center justify-center min-h-screen bg-gray-900">
                <h1 className="text-4xl font-bold mb-4 text-white">Create Your Booze Buddy Account</h1>
                ...
                {role && (
                    <form onSubmit={handleFormSubmit} className={`mt-6 space-y-4 w-full max-w-md ${role === 'supplier' ? 'flex flex-col items-center' : ''}`}>
                        <div className={`grid ${role === 'store-manager' ? 'grid-cols-1 md:grid-cols-2 gap-4' : ''}`}>
                            <div>
                                <input
                                    name="name"
                                    type="text"
                            ...
                            {role === 'store-manager' && (
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => setStoreDetails({ ...storeDetails, storeNumber: e.target.value })}
                                        className="w-full px-4 py-2 border rounded text-black"
                                    />
                                    <input
                                        name="state"
