...
console.log('AWS_REGION:', process.env.AWS_REGION); // Verify the environment variable
console.log('AWS_S3_BUCKET_NAME:', process.env.AWS_S3_BUCKET_NAME); // Verify the environment variable
